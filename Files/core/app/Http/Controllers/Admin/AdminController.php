...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $doctors = Doctor::orderBy('id', 'DESC')->with('department')->limit(8)->get();
        $doctor['all'] = Doctor::count();
        $doctor['pending'] = Doctor::where('status', 0)->count();
        $doctor['approved'] = Doctor::where('status', 1)->count();
        $doctor['banned'] = Doctor::where('status', 2)->count();
        return view('admin.dashboard', compact('pageTitle', 'doctor', 'department', 'ads', 'subscribers', 'doctors', 'city'));
    }
