<div
  class="sidebar {{ sidebarVariation()['selector'] }} {{ sidebarVariation()['sidebar'] }}
{{ sidebarVariation()['overlay'] }} {{ sidebarVariation()['opacity'] }}"
  data-background="{{ getImage('assets/admin/images/sidebar/2.jpg', '400x800') }}">
  <button class="res-sidebar-close-btn"><i class="las la-times"></i></button>
  <div class="sidebar__inner">
    <div class="sidebar__logo">
      <a href="{{ route('admin.dashboard') }}" class="sidebar__main-logo">logo</a>
      ...
      <ul class="sidebar__menu">
        ...
        <li class="sidebar-menu-item  {{ menuActive('admin.department.index') }}">
          <a href="{{ route('admin.department.index') }}" class="nav-link"
            data-default-url="{{ route('admin.department.index') }}">
        ...
        <li class="sidebar-menu-item sidebar-dropdown">
          <a href="javascript:void(0)" class="{{ menuActive('admin.doctor*', 3) }}">
            <i class="menu-icon las la-user-nurse"></i>
            <span class="menu-title">@lang('Manage Doctor') </span>
            @if (0 < $pending_doctor)
          ...
          <div class="sidebar-submenu {{ menuActive('admin.doctor*', 2) }} ">
            <ul>
              ...
              <li class="sidebar-menu-item {{ menuActive('admin.doctor.pending') }} ">
                <a href="{{ route('admin.doctor.pending') }}" class="nav-link">
                  <i class="menu-icon las la-dot-circle"></i>
                  <span class="menu-title">@lang('Pending')</span>
                  @if ($pending_doctor)
                    <span class="menu-badge pill bg--primary ml-auto">{{ $pending_doctor }}</span>
                  @endif
                </a>
              </li>
              <li class="sidebar-menu-item {{ menuActive('admin.doctor.approved') }} ">
                <a href="{{ route('admin.doctor.approved') }}" class="nav-link">
                  <i class="menu-icon las la-dot-circle"></i>
                  <span class="menu-title">@lang('Approved')</span>
                </a>
              </li>

              <li class="sidebar-menu-item {{ menuActive('admin.doctor.banned') }} ">
                <a href="{{ route('admin.doctor.banned') }}" class="nav-link">
                  <i class="menu-icon las la-dot-circle"></i>
        ...
        <li class="sidebar-menu-item  {{ menuActive('admin.ads*') }}">
          <a href="{{ route('admin.ads.index') }}" class="nav-link" data-default-url="{{ route('admin.ads.index') }}">
