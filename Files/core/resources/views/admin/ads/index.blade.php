                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td data-label=">@lang('Ad Size')">
                                    <span class="text--small badge font-weight-normal badge--primary">{{$advr->size}}</span>
                                </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-lg" name="name" placeholder="@lang("Enter Name")" value="{{old('name')}}" id="name" maxlength="40" required="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-lg" name="size" id="size">
                        ...
                        <option value="509x511">@lang('509x511')</option>
                        <option value="380x550">@lang('380x550')</option>
                        <option value="462x463">@lang('462x463')</option>
                        <option value="992x204">@lang('992x204')</option>
                    </select>
                </div>
