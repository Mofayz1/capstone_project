@php
  ...
  $doctors = App\Models\Doctor::where('status', 1)->where('featured', 1)->orderBy('id','desc')->take(8)->get();
@endphp

<section class="pt-100 pb-100 bg_img" style="background-image: url({{getImage('assets/images/frontend/doctor/'. @$doctor->data_values->background_image, '1920x960')}});">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
